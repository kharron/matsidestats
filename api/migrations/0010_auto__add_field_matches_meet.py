...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Matches.meet'
        db.add_column(u'trackmatch_matches', 'meet',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['trackmatch.Meets']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Matches.meet'
        db.delete_column(u'trackmatch_matches', 'meet_id')
