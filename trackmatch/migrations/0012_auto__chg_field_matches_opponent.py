...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Matches.opponent' to match new field type.
        db.rename_column(u'trackmatch_matches', 'opponent', 'opponent_id')
        # Changing field 'Matches.opponent'
        db.alter_column(u'trackmatch_matches', 'opponent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['trackmatch.Opponents'], null=True))
        # Adding index on 'Matches', fields ['opponent']
        db.create_index(u'trackmatch_matches', ['opponent_id'])


    def backwards(self, orm):
        # Removing index on 'Matches', fields ['opponent']
        db.delete_index(u'trackmatch_matches', ['opponent_id'])


        # Renaming column for 'Matches.opponent' to match new field type.
        db.rename_column(u'trackmatch_matches', 'opponent_id', 'opponent')
        # Changing field 'Matches.opponent'
        db.alter_column(u'trackmatch_matches', 'opponent', self.gf('django.db.models.fields.IntegerField')(null=True))
