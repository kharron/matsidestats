...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MatchScore.period'
        db.add_column(u'trackmatch_matchscore', 'period',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MatchScore.period'
        db.delete_column(u'trackmatch_matchscore', 'period')
