...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Teams.api_key'
        db.add_column(u'trackmatch_teams', 'api_key',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Teams.api_key'
        db.delete_column(u'trackmatch_teams', 'api_key')
    ...
    models = {
        u'trackmatch.matches': {
            ...
            'match_complete': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
        ...
        u'trackmatch.teams': {
            ...
            'api_key': ('django.db.models.fields.CharField', [], {'max_length': '64', 'blank': 'True'}),
