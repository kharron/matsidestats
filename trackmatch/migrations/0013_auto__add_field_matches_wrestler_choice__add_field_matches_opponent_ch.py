...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Matches.wrestler_choice'
        db.add_column(u'trackmatch_matches', 'wrestler_choice',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)

        # Adding field 'Matches.opponent_choice'
        db.add_column(u'trackmatch_matches', 'opponent_choice',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Matches.wrestler_choice'
        db.delete_column(u'trackmatch_matches', 'wrestler_choice')

        # Deleting field 'Matches.opponent_choice'
        db.delete_column(u'trackmatch_matches', 'opponent_choice')
    ...
    models = {
        u'trackmatch.matches': {
            ...
            'opponent_choice': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
            ...
            'wrestler_choice': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'})
        },
