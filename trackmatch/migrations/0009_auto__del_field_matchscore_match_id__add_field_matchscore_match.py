...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MatchScore.match_id'
        db.delete_column(u'trackmatch_matchscore', 'match_id_id')

        # Adding field 'MatchScore.match'
        db.add_column(u'trackmatch_matchscore', 'match',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=99, to=orm['trackmatch.Matches']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'MatchScore.match_id'
        db.add_column(u'trackmatch_matchscore', 'match_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=99, to=orm['trackmatch.Matches']),
                      keep_default=False)

        # Deleting field 'MatchScore.match'
        db.delete_column(u'trackmatch_matchscore', 'match_id')
