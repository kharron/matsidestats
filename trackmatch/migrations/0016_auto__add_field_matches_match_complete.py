...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Matches.match_complete'
        db.add_column(u'trackmatch_matches', 'match_complete',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Matches.match_complete'
        db.delete_column(u'trackmatch_matches', 'match_complete')
